<%@ Page Title="Log in" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ProgrammersSpot.WebClient.Account.Login" Async="true" %>
        ...
        <div class="col-md-7">
            <section id="loginForm">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        <div class="col-md-offset-2 col-md-10">
                            <asp:Button runat="server" OnClick="LogIn" Text="Log in" CssClass="btn btn-default special" />
                        </div>
                    </div>
                </div>
                <p>
